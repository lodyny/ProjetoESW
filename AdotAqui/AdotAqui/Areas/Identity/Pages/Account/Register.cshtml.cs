...
namespace AdotAqui.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new User { UserName = Input.Email, Email = Input.Email, Birthday = Input.Birthday, Name = Input.Name, PhoneNumber = Input.PhoneNumber };
